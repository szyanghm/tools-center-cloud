...
public class ChatProto {
    ...
    public static final int MOVE_CHESS_PROTO = 9 << 8 | 220; //走棋消息
    ...
    public static void main(String[] args) {
        System.out.println(MOVE_CHESS_PROTO);
    }



    public static String buildMessProto(String id,String uid,String nick,String avatarUrl, String mess) {
        ChatProto chatProto = new ChatProto(MESS_PROTO, mess);
        chatProto.extend.put("miniUserId", uid);
        chatProto.extend.put("nickName", nick);
        chatProto.extend.put("id", id);
        chatProto.extend.put("avatarUrl",avatarUrl);
        chatProto.extend.put("createdTime", DateUtil.getCurrentTime());
        return JSONObject.toJSONString(chatProto);
    }
