package com.tools.center.utils.ofd.utils;

import com.tools.center.utils.FileUtil;
import com.tools.center.utils.ofd.OFDInfo;
import com.tools.center.utils.ofd.OFDPainter;
...
//                    ""
                    ...
                    //测试根证书
                    "",
                    ""
            };
    ...
    public static byte[] ofdToImage(File file){
        try {
            OFDInfo ofdInfo = OfdParser.parse(file);
            OFDPainter ofdPainter = ofdInfo.getOfdPainter();
            BufferedImage bufferedImage = ofdPainter.convertAsSingleImage(150);
            byte[] bytes = FileUtil.imageToBytes(bufferedImage);
            return bytes;
        } catch (Exception e) {
