package com.tools.center.utils.pdf;
...
public class InvoiceExtractor {
    ...
    public static InvoiceData extract(String filename) throws Exception {
        ...
        //关键字(机器编号)坐标：y:" + jqbhCor[0] + ", x:" + jqbhCor[1]
        ...
        //"关键字（货物或应税）坐标：y:" + hwhysCor[0] + ", x:" + hwhysCor[1]
        ...
        //关键字（价税合计）坐标：y:" + jshjCor[0] + ", x:" + jshjCor[1]
        ...
        // 购买方：
        stripper.addRegion("GMF",extRectangle(gmfkhhjzhCor,jqbhCor,maqX));

        // 销售方
        stripper.addRegion("XSF", extRectangle(xsfkhhjzhCor,jshjCor,maqX));
     ...
     * @throws Exception
     */
    private static String readText(Invoice invoice, String pdfPath) throws Exception {
        // 开始读文字
        PDDocument doc = PDDocument.load(new File(pdfPath));
        PDPageTree allPages = doc.getDocumentCatalog().getPages();
    ...
    public static Rectangle extRectangle(float[] gmfkhhjzhCor,float[] jqbhCor,int maqX){
